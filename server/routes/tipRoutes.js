...
const { addTip, getTips, searchTips, likeTip, getOrganizationTips } = require("../controllers/tipController");

router.post("/", authMiddleware, addTip);
router.get("/", authMiddleware, getTips);
router.get("/organization", authMiddleware, getOrganizationTips);
